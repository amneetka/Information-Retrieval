...
from .etl import jsonToDF, influence_score, fetch_topics_db, topic_analysis
import json
...
def search_tweets():
    ...
    for _ in range(len(covid_g['total_cases'])):
        covid_g['total_cases'][_] = (covid_g['total_cases'][_])/1000
    covid_g['counts'] = covid_g['counts'][::-1]
    ...
    final_result = {
        ...
        'covid': covid_g,
        'bar': {'label':b_label,'data':b_data},
        'total': numFound
    }
    print(final_result['bar'])
    result = final_result
    temp11 = []
